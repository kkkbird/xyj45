...
string ask_me()
{
	...
	say("\n玄难又道：请你速去告知罗汉堂玄苦大师，请他即刻招集般若堂诸罗汉于西练武场集合。\n");
        ...
        for(j=1; j<10; j++) 
	{
                if(!( room = find_object("/d/suburb/xkx/shaolin/banruo" + j)) )
                room = load_object("/d/suburb/xkx/shaolin/banruo" + j);
...
int fighting(object me, object fighter, int count)
{
	...
	if(!( room1 = find_object("/d/suburb/xkx/shaolin/wuchang1")) )
	room1 = load_object("/d/suburb/xkx/shaolin/wuchang1");
...
int do_back(object me)
{
	...
	message("vision", "\n玄难大师也挥了挥手， 般若堂长老们随即也离开练武场。\n", environment(me) );
        ...
        room1->set("exits/south", "/d/suburb/xkx/shaolin/houdian" );
        room1->set("exits/north", "/d/suburb/xkx/shaolin/fzlou");
        room1->set("exits/east",  "/d/suburb/xkx/shaolin/wuchang2");
        room1->set("exits/west",  "/d/suburb/xkx/shaolin/wuchang1"   );
	...
	for(i=1; i<10; i++) 
	{
                if(!( room2 = find_object("/d/suburb/xkx/shaolin/banruo" + i)) )
                room2 = load_object("/d/suburb/xkx/shaolin/banruo" + i);
	...
	me->move("/d/suburb/xkx/shaolin/banruo5");
