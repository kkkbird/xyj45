...
mapping BigWay=([
                "/d/suburb/es/choyin/court1":({"south",0}),
                "/d/suburb/es/choyin/crossroad":({"east","north"}),
                "/d/suburb/es/choyin/s_street5":({"east","west"}),
                "/d/suburb/es/choyin/s_street4":({"east","west"}),
                "/d/suburb/es/choyin/s_street1":({"north","west"}),
                "/d/suburb/es/choyin/s_street2":({"north","south"}),
                "/d/suburb/es/choyin/tree_tomb":({"north","south"}),
                "/d/suburb/es/choyin/n_street3":({"north","south"}),
                "/d/suburb/es/choyin/n_street2":({"north","south"}),
                "/d/suburb/es/choyin/n_street1":({"north","south"}),
                "/d/suburb/es/choyin/n_gate":({"west","south"}),
                "/u/cloud/sunhill/road1":({"north","east"}),
                "/d/suburb/es/snow/sroad3":({"north","east"}),
                "/d/suburb/es/snow/sroad4":({"north","south"}),
                "/d/suburb/es/waterfog/sroad1": ({0,"south"}),
                ]);
      ...
      if (objectp(catchwho=this_object()->query("CatchWho")))
        {
            if (BigWay[file_name(environment())][direction]==0)
                        {
        say("try to patrol\n");
                        start_room=find_object("/d/suburb/es/choyin/yamen.c");
                        oldman=find_object("/d/suburb/es/choyin/npc/judgeman.c");
...
/*      for (i=0;i<2;i++)
                {
                seteuid(getuid());
                ob=new("/d/suburb/es/choyin/npc/yamen_po.c");
                ob->set("call_out",1);
